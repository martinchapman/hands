 ...
 *
 */
public class LowEdgeCostVariableFixedDistance extends VariableFixedDistance {

	/**
	 * @param graph
	 */
	public LowEdgeCostVariableFixedDistance(GraphController <StringVertex, StringEdge> graphController, int hideLocations, int minHideDistance) {
