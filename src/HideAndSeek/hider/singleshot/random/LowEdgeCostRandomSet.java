 ...
 *
 */
public class LowEdgeCostRandomSet extends RandomSet {
	 ...
	 */
	public LowEdgeCostRandomSet(GraphController<StringVertex, StringEdge> graphController, int numberOfHideLocations) {
