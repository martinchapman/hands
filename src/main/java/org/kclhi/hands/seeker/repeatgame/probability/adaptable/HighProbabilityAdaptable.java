...
public class HighProbabilityAdaptable extends HighProbability implements AdaptiveSeeker {
  ...
  */
  ...
  /* (non-Javadoc)
  * @see org.kclhi.hands.seeker.AdaptiveSeekerStrategy#performanceOfSelf()
  */
  @Override
  ...
  /* (non-Javadoc)
  * @see org.kclhi.hands.seeker.repeatgame.probability.HighProbability#endOfRound()
  */
  ...
  /* (non-Javadoc)
  * @see org.kclhi.hands.seeker.repeatgame.probability.InverseHighProbability#endOfGame()
  */
  @Override
