...
*
*/
public class RandomWalkStationaryChanceLowGasVariableGas extends RandomWalkStationaryChance implements LowGasGraphTraverser {

  public RandomWalkStationaryChanceLowGasVariableGas(GraphController<StringVertex, StringEdge> graphController) {
