 ...
 * by user. For most operations user should use {@link org.mapdblocal.DB} class.
 * </p><p>
 *
 ...
 *  <li> {@link org.mapdblocal.StoreWAL} - permanent record store with transactions
...
public interface Engine  extends Closeable {
    ...
    /**
     * <p>
     * Content of this map is manipulated by {@link org.mapdblocal.DB} class.
     * </p>
     * There are 8 reserved record ids. They store information relevant to
     * {@link org.mapdblocal.DB} and higher level functions. Those are preallocated when store is created.
     */
    long RECID_NAME_CATALOG = 1;

    /**
     * <p>
     * Points to class catalog. A list of classes used in {@link org.mapdblocal.SerializerPojo}
